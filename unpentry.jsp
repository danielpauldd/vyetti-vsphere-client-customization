...
<form #loginForm="ngForm" (ngSubmit)="login()">
  ...
  <p id="usernameID" class="loginRow" >
      ...
      <input [(ngModel)]="username" id="username" class="margeTextInput" type="text" placeholder="${username_placeholder}"/>
    </p>
    <p id="passwordID" class="loginRow" >
      <span class="loginLabel">${password}:</span>
      <input [(ngModel)]="password" id="password" class="margeTextInput" type="password"/>
    </p>
    <p id="sessionID">
...
<script type="text/javascript" src="../../resources/js/login-animation.js"></script>
<!-- End of vYetti Customization -->
<div id="bg-banner"></div>
<!--
Original vSphere Client Login Form
<div id="loginForm">
   <p id="usernameID" class="loginRow" >
      <span class="loginLabel">${username}:</span>
